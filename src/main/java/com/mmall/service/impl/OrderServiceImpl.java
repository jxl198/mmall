...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse pay(Long orderNo, Integer userId, String path) {
        ...
        String body = new StringBuilder().append("订单").append(order.getOrderNo())
        ...
        for (OrderItem orderItem : orderItemList) {
            GoodsDetail goods1 = GoodsDetail.newInstance(orderItem.getId().toString(), orderItem.getProductName(),
                    BigDecimalUtil.multi(orderItem.getCurrentUnitPrice().doubleValue(), new Double(100)).longValue(), orderItem.getQuantity());
...
//                targetFile.delete();
    ...
    private long generateOrderNo() {//生成订单
    ...
    private ServerResponse<List<OrderItem>> getCartOrderItem(Integer userId, List<Cart> cartList) {
        ...
        for (Cart cartItem : cartList) {
            ...
            orderItem.setTotalPrice(BigDecimalUtil.multi(product.getPrice().doubleValue(), cartItem.getQuantity()));
