...
public class CategoryServiceImpl implements ICategoryService {
    ...
    public ServerResponse<List<Integer>> selectCateogoryAndChildrenById(Integer categoryId){
        ...
        findChildrenCateogry(categorySet,categoryId);
    ...
    private Set<Category> findChildrenCateogry(Set<Category>categorySet,Integer categoryId){
        ...
        for(Category categoryItem:categoryList){
            findChildrenCateogry(categorySet,categoryItem.getId());
        }
        return categorySet;
